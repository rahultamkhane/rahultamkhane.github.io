	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, the user is ask to enter 5 integer elements that will save in array <mark>arr</mark>. Then we calculate the sum and average of these number display it on console.</p>
