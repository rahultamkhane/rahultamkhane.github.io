	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, you'll learn to declare structure "employee" having data member name, age, street and city. Accept data for two employees and display it.</p>
...
Dinesh, 38, ConvexMall, Mumbai</code></pre>
				</div>
				<!-- DESC -->
