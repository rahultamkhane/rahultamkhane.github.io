        ...
        <div class="bread-inner">
          ...
          <div class="bread-menu">
            <ul>
              ...
              <li><a href="<?php echo SITE_DIR;?>c-programming/programs/">C Programming</a></li>
            </ul>
          </div>
          <!-- Bread Title -->
...
<div class="row">
    ...
    <?php 
	include("c_programs_navigation.php");
	?>
    ...
    <!-- Page Content -->
      ...
      <ol class="custom-counter">
        ...
        <li><a href="c-input-output">C Program to Display the Numbers Entered by User</a></li>
        ...
        <li><a href="sum-natural-numbers">C Program to Find Sum of Natural Numbers</a></li>
        ...
        <li><a href="arithmetic-operations-function">C Program to Display Arithmetic Operations Using Function</a></li>
        <li><a href="swap-numbers-call-by-value">C Program to Swap Two Variables Using Call by Value</a></li>
        <li><a href="numbers-product-function">C Program to Find Product of Numbers Using Function</a></li>
        <li><a href="number-cube-function">C Program to Find Cube of a Number Using Function</a></li>
        <li><a href="nth-power-using-function">C Program to Calculate nth Power of a Number Using Function</a></li>
        <li><a href="nth-power-function">C Program to Find Nth Power Using Function</a></li>
        <li><a href="factorial-using-function">C Program to Find Factorial of a Number Using Function</a></li>
        <li><a href="fibonacci-series-using-function">C Program to Display Fibonacci Series Using Function</a></li>
        <li><a href="array-max-number">C Program to Find Largest Number in an Array</a></li>
        <li><a href="circle-area-function">C Program to Find Area of Circle Using Function</a></li>
        <li><a href="circle-diameter-area-function">C Program to Find Diameter, Circumference and Area of Circle Using Function</a></li>
        <li><a href="swap-numbers-call-by-reference">C Program to Swap Two Numbers Using Call by Reference</a></li>
        <li><a href="factorial-recursion">C Program to Find Factorial of a Number Using Recursion</a></li>
        <li><a href="fibonacci-series-recursive">C Program to Display Fibonacci Series Using Recursion</a></li>
        <li><a href="reverse-string-recursive">C Program to Print Reverse of String Using Recursion</a></li>

        <li><a href="pointer-print-addresses">C Program to Print Address of Pointers</a></li>
        <li><a href="pointer-sum-numbers">C Program to Add Two Numbers Using Pointers</a></li>
        <li><a href="pointer-arithmetic">C Program to Perform Arithmetic Operations Using Pointers</a></li>
        <li><a href="swap-numbers-pointers">C Program to Swap Two Numbers Using Pointers</a></li>
        <li><a href="numbers-product-pointer">C Program to Find Product of Numbers Using Pointers</a></li>
        <li><a href="fibonacci-series-pointers">C Program to Print Fibonacci Series Using Pointers</a></li>
        <li><a href="pointer-string-length">C Program to Print Length of String Using Pointers</a></li>
        <li><a href="string-length-pointer-function">C Program to Find String Length Using Pointers</a></li>
        <li><a href="string-length-pointer">C Program to Count String Length Using Pointers</a></li>
        <li><a href="pointers-array">C Program to Display Array of Pointers</a></li>
        <li><a href="pointer-to-array">C Program to Display Array Elements Using Pointer to Array</a></li>
        <li><a href="array-sum-pointers">C Program to Find Sum of Elements Stored in Given Array Using Pointers</a></li>
        <li><a href="pointers-to-functions">C Program to Demonstrate Pointers to Functions</a></li>
        ...
        <li><a href="arrow-operator">C Program to Demonstrate Use of Arrow (->) Operator</a></li>
        <li><a href="sort-students">C Program to Sort Students </a></li>
