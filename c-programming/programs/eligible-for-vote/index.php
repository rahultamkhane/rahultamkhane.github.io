	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, the user is ask to input his/her age, depending on that we will check his age. If age is greater than or equal to 18 then we will display he/she is eligible to vote otherwise not.</p>
...
You are eligible for voting.</code></pre>
				</div>
				<!-- DESC -->
