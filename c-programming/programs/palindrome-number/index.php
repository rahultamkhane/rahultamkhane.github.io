...
$description = "In this program, you'll learn to check a given number is Palindrome number or not.
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, you'll learn to check a given number is Palindrome number or not.
...
3) Check if the reversed number is equal to the given number.</p>
