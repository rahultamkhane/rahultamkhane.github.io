...
$description = "In this program, the user is ask for length and breadth of rectangle, then the permitere and area is calculated. Finally the result will be displayed on console.
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, the user is ask for length and breadth of rectangle, then the permitere and area is calculated. Finally the result will be displayed on console.

Formulas: 

Area of Rectangle = l x b
 
Perimeter of Rectangle = 2 * ( l + b )</p>
...
Area = 35 and Perimeter = 24</code></pre>
				</div>
				<!-- DESC -->
