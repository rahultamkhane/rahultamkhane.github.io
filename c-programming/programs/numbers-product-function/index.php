...
$title = "C Program to Find Product of Numbers Using Function";
$description = "In this program, you'll learn to find product of two numbers using function.
    ...
    <div class="row">
      <div class="col-12">
        <div class="bread-inner">
          ...
          <!-- Bread Title -->
          <div class="bread-title"><h2>C Program to Find Product of Numbers Using Function</h2></div>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				<h2 class="blog-title">C Program to Find Product of Numbers Using Function</h2>
				<p>In this program, you'll learn to find product of two numbers using function.
...
long product(int x, int y)
{
    return x*y;
				...
				<div class="output">
					<pre class="hljs"><code class="plaintext p-3">Enter the values of a & b: 42 50
Product of 42 and 50 = 2100</code></pre>
				</div>
				<!-- DESC -->
