...
$description = "In this program, you'll learn to compare two strings.

This <mark>strcmp()</mark> function is used to compare the string arguments. 
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, you'll learn to compare two strings.

This <mark>strcmp()</mark> function is used to compare the string arguments. 

It compares strings lexicographically which means it compares both the strings character by character. 

It starts comparing the very first character of strings until the characters of both strings are equal or NULL character is found.</p>
...
Enter the second string
yello
Both strings are NOT EQUAL</code></pre>
				</div>
				<!-- DESC -->
