...
$title = "C Program to Find String Length Using Pointers";
$description = "In this program, you will learn to find length of string using pointers. 
    ...
    <div class="row">
      <div class="col-12">
        <div class="bread-inner">
          ...
          <!-- Bread Title -->
          <div class="bread-title"><h2>C Program to Find String Length Using Pointers</h2></div>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				<h2 class="blog-title">C Program to Find String Length Using Pointers</h2>
				<p>In this program, you will learn to find length of string using pointers. 
