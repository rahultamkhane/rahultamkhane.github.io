...
$title = "Java Applet Program to draw and fill Polygon";
$description = "Write a Java Applet Program to draw and fill Polygon.";
    ...
    <div class="row">
      <div class="col-12">
        <div class="bread-inner">
          ...
          <!-- Bread Title -->
          <div class="bread-title"><h2>Java Applet Program to draw and fill Polygon</h2></div>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				<h2 class="blog-title">Java Applet Program to draw and fill Polygon</h2>
				<p>Write a Java Applet Program to draw and fill Polygon.</p>
...
*/
				...
				<div class="output"><img src="draw-fill-polygon.jpg"></div>
				<!-- DESC -->
