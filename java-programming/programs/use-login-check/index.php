...
$title = "Java Program to Throw Exception on Wrong Password";
$description = "Write a Java program to raise a user defined exception if username is less than 6 character and password does not match.";
    ...
    <div class="row">
      <div class="col-12">
        <div class="bread-inner">
          ...
          <!-- Bread Title -->
          <div class="bread-title"><h2>Java Program to Throw Exception on Wrong Password</h2></div>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				<h2 class="blog-title">Java Program to Throw Exception on Wrong Password</h2>
				<p>Write a Java program to raise a user defined exception if username is less than 6 character and password does not match.</p>
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("The finally statement is executed");
				...
				<div class="output">
					<pre class="hljs"><code class="plaintext p-3">Enter username :: Raj
