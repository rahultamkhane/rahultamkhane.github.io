...
$description = "Write a Java program to demonstrate use of 'static' keyword.";
...
?>
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>Write a Java program to demonstrate use of 'static' keyword.</p>
				...
				<div id="code" class="source-code">
					<pre><code class="java">public class StaticDemo {
	...
	public static void main(String args[]) {
		...
		System.out.println(count+" objects are created!");
				...
				<div class="output">
					<pre class="hljs"><code class="plaintext p-3">3 objects are created!
</code></pre>
				</div>
				<!-- DESC -->
