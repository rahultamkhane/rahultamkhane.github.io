...
$title = "Develop an android application to place Name, Age and Mobile number on the display screen using Absolute Layout | " . SITE_NAME;
$description = "Develop an android application to place Name, Age and Mobile number on the display screen using Absolute Layout";
    ...
    <div class="col-sm-8 pl-5 pt-4">
      <div class="container">
        <div class="mydiv">
          ...
          <body>
            <h1>Develop an android application to place Name, Age and Mobile number on the display screen using Absolute Layout</h1>
...
&lt;/AbsoluteLayout&gt;
            ...
            <pre><code class="java">package com.example.absolutelayout;
