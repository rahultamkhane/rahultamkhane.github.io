	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, the user is asked to enter 10 elements in an array. After that user is ask for element that he/she wants to search in an Array. Then we search an element from starting to end until it is found. Finally, we display whether element is found or not on the screen.
</p>
...
int main( )
{
    ...
    if (i == 10)
        cout&lt;&lt;"Number is not found in the array."&lt;&lt; search;
    return 0;
}
</code></pre>
				</div> <!--/ End source-code -->
