...
$description = "In this program, you'll learn to declare structure 'library' having member variables are acc_no, title, author, price and isIssued. Accept data for three library books and display it.
";
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, you'll learn to declare structure 'library' having member variables are acc_no, title, author, price and isIssued. Accept data for three library books and display it.
</p>
