...
$description = "In this program, you'll learn to check a given string is Palindrome or not.<br><br>A string is called Palindrome, if the original string and reverse string of original string are same.<br><br>To check if a string is palindrome or not follow below steps:<br><br>1) Declare two string: f and r.<br><br>2) Find Reverse of string.<br><br>3) Check if the reversed string is equal to the given string.
";
