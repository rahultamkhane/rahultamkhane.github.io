	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, the user is ask to enter the marks of 5 subjects. Then the total marks is calculated. Finally the user will get the percentage and the grade.
</p>
