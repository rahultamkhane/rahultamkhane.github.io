	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, you'll learn to check given year is Leap Year or not. <br><br>A year is leap if it divisible by 4. A year is a leap year if it satisfy following conditions:<br><br>
1) It is evenly divisible by 100<br>
2) If it is divisible by 100, then it should also be divisible by 400<br>
