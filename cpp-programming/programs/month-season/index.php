...
$description = "In this program, the user is ask to enter the month, then the output will be the season in that month.<br><br>For example, if user enter the month number as 6 then season will be RAINY SEASON.
";
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, the user is ask to enter the month, then the output will be the season in that month.<br><br>For example, if user enter the month number as 6 then season will be RAINY SEASON.
</p>
