	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, we will display the sum of all odd numbers from 1 to 100. We have used for loop and will increment a number by 2 and make sum of it in previous result. Finally we will print sum of console.
</p>
...
int main()
{
    ...
    return 0;
				...
				<div class="output">
					<pre class="hljs"><code class="plaintext p-3">Sum of all odd numbers between 1 - 100 is: 2500
</code></pre>
				</div>
				<!-- DESC -->
