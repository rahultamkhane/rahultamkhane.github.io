	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>In this program, the user is asked to enter the elements of the two matrices a and b. Then the elements of these two matrices are multiplied and saved it in third matrix. Finally, the result (third matrix) is printed on the screen.
</p>
