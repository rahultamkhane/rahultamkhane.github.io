...
$title = "JavaScript Program to Change Case of Text";
$description = "Write a JavaScript program to change case of text either uppercase or lowercase.";
    ...
    <div class="row">
      <div class="col-12">
        <div class="bread-inner">
          ...
          <!-- Bread Title -->
          <div class="bread-title"><h2>JavaScript Program to Change Case of Text</h2></div>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				<h2 class="blog-title">JavaScript Program to Change Case of Text</h2>
				<p>Write a JavaScript program to change case of text either uppercase or lowercase.</p>
...
&lt;/html&gt;
				...
				<div class="output">
					<pre><code class="plaintext"><img src="word-change-case.jpg"></code></pre>
				</div>
				<!-- DESC -->
