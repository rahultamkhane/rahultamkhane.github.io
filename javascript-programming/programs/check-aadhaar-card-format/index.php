...
$description = "Write a JavaScript program to check aadhaar card format using regular expression.";
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>Write a JavaScript program to check aadhaar card format using regular expression.</p>
...
&lt;head&gt;
    &lt;title&gt;Regular expression - Aadhar card format check&lt;/title&gt;
    &lt;script&gt;
        function check()
        {
            var aadhar_no = myform.aadhar_no.value;
            re = /^\d{4}\s\d{4}\s\d{4}$/
...
&lt;body&gt;
&lt;form name="myform"&gt;
    Enter AADHAR no. &lt;input type="text" id="aadhar_no"/&gt;&lt;br&gt;
...
&lt;/html&gt;
				...
				<div class="output">
					<pre><code class="plaintext"><img src="check-aadhaar-card-format.jpg"></code></pre>
				</div>
				<!-- DESC -->
