...
$title = "JavaScript Program for Calling Function from Another Frame ";
$description = "Write a JavaScript program for calling function from another frame .";
    ...
    <div class="row">
      <div class="col-12">
        <div class="bread-inner">
          ...
          <!-- Bread Title -->
          <div class="bread-title"><h2>JavaScript Program for Calling Function from Another Frame </h2></div>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				<h2 class="blog-title">JavaScript Program for Calling Function from Another Frame </h2>
				<p>Write a JavaScript program for calling function from another frame .</p>
...
&lt;/html&gt;
				...
				<div class="output">
					<pre><code class="plaintext"><img src="calling-function-from-another-frame.jpg"></code></pre>
				</div>
				<!-- DESC -->
