...
$title = "JavaScript Program to Change Text Color on Button Click";
$description = "Write a JavaScript program to change text color on button click.";
    ...
    <div class="row">
      <div class="col-12">
        <div class="bread-inner">
          ...
          <!-- Bread Title -->
          <div class="bread-title"><h2>JavaScript Program to Change Text Color on Button Click</h2></div>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				<h2 class="blog-title">JavaScript Program to Change Text Color on Button Click</h2>
				<p>Write a JavaScript program to change text color on button click.</p>
...
&lt;/html&gt;
				...
				<div class="output">
					<pre><code class="plaintext"><img src="change-color-on-button-click.jpg"></code></pre>
				</div>
				<!-- DESC -->
