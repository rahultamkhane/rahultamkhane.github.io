...
$description = "Write a JavaScript program to display today's day.";
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				...
				<p>Write a JavaScript program to display today's day.</p>
...
&lt;/html&gt;
				...
				<div class="output">
					<pre><code class="plaintext"><img src="display-today-day.jpg"></code></pre>
				</div>
				<!-- DESC -->
