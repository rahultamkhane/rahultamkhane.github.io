...
$title = "JavaScript Program to Swap Two Images";
$description = "Write a JavaScript program to swap two images.";
    ...
    <div class="row">
      <div class="col-12">
        <div class="bread-inner">
          ...
          <!-- Bread Title -->
          <div class="bread-title"><h2>JavaScript Program to Swap Two Images</h2></div>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="col-sm-8">
		<div class="blog-single-main">
			<div class="blog-detail">
				<h2 class="blog-title">JavaScript Program to Swap Two Images</h2>
				<p>Write a JavaScript program to swap two images.</p>
...
&lt;/html&gt;
				...
				<div class="output">
					<pre><code class="plaintext"><img src="swap-images.jpg"></code></pre>
				</div>
				<!-- DESC -->
